...
class UpTransition3d(nn.Module):
    def __init__(self, inChans, outChans, nConvs, prob=0.2, embedding=False):
        ...
        self.ops = _make_nConv3d(outChans, nConvs, prob)
        self.conv = nn.Conv3d(midChans, outChans, kernel_size=1)
...
class VNet3d(nn.Module):
    ...
    def __init__(self, image_channel, numclass, init_features=16, image_shape=(80,80,80)):
        ...
        self.up_tr256 = UpTransition3d(self.features * 16 + 1, self.features * 8, 3, prob=0.2, embedding=True)
    ...
    def forward(self, x, emb_codes):
        ...
        out256 = torch.cat((out256, emb_pos), dim=1)
